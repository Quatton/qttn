...
2. Svelte: While you can create `writable` stores outside of components,
   but it is not usable anywhere else other than Svelte components.
...
If you noticed that, this is how I glued both Solid and Vue together,
which I know, looks so sacrilegious.
